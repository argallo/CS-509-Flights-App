...
public class ViewManager {
	 ...
	 *            the type of transition to make when moving to new view
	 */
	public void transitionViewTo(ViewID newViewID, TransitionType transitionType) {
		transitionManager.createTransition(stage.getCurrentView(), viewBuilder.build(newViewID), newViewID, stage,
				transitionType);
	}
	...
	/**
	 * Used for login/create account screen, quick way to unfocus all objects in
	 * a stage
	 */
