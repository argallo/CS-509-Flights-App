...
public class DisplayTripsView extends BaseView {
	...
	static SeatClass seatClassSelection = SeatClass.ECONOMY; // TODO: MAKE
																// DYNAMIC
	...
	public void init() {
		...
		radioButtonsLabels = new TextLabel("Price:     Time:          Economy:     First Class:",
				Assets.getInstance().getXSmallFont());
		...
		economy.setButtonAction(new ButtonAction() {
			...
			public void buttonPressed() {
				...
				if (checkBox.isChecked()) {
					returnTripsPanel.setSeatClass(seatClassSelection);
				}
			}
		});
		...
		departureAirportDropdown
				.setSelected(Constants.departureAirport.getName() + " (" + Constants.departureAirport.getCode() + ")");
		arrivalAirportDropdown.setItems(airportNames);
		arrivalAirportDropdown
				.setSelected(Constants.arrivalAirport.getName() + " (" + Constants.arrivalAirport.getCode() + ")");
